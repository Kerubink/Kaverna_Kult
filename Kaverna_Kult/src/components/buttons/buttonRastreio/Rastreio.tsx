...
function ButtonRastreio() {
  ...
  return (
    <Link to={"/checkoutOrder"}>
      <button
        className={`bg-slate-500 fixed bottom-4 right-4 text-white font-bold h-12 gap-2 flex items-center justify-center rounded-full opacity-50 hover:opacity-100 transition-all duration-500 ${
