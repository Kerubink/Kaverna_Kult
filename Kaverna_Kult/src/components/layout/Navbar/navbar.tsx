    ...
    <div className="w-full p-3 flex flex-col gap-3 sticky z-50 top-0 bg-black text-white">
      <div className="flex items-center justify-between gap-4 relative">
        ...
        <div className="flex items-center gap-2">
          {/* Favoritos e Carrinho com ícones sempre visíveis */}
      ...
      {/* Mostrar NavigationMenu apenas em telas grandes */}
      <div className={`flex justify-center ${isMenuOpen ? "hidden" : "md:block"}`}>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-black text-white p-4">
          <div className="flex flex-col gap-3">
            <a href="/" className="text-white py-2">Novidades</a>
            <a href="/" className="text-white py-2">Coleções</a>
            <a href="/" className="text-white py-2">Mais Vendidos</a>
            <a href="/docs" className="text-white py-2">Contato</a>
          </div>
        </div>
      )}
    </div>
